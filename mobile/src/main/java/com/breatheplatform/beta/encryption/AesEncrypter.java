...
//    }
     ...
     * @param mykey key used to encrypt
     * @param iv a IvParameterSpec instance with the bytes used as initialization vector (if ivParam is null an initialization vector will be randomly generated)
     */
    public AesEncrypter(SecretKey mykey, IvParameterSpec iv) {
        key = mykey;
...
//        try {
//            return new String(encKey, "UTF-8");
//        } catch (Exception e) {
//            return null;
//        }
//    }
