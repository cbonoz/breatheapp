...
//         */
        ...
        public void onCreate(SurfaceHolder holder) {
            ...
            setWatchFaceStyle(new WatchFaceStyle.Builder(MyWatchFace.this)
                    ...
                    .setShowSystemUiTime(true) //show system-provided time.
...
//
            ...
            mTextPaint = createTextPaint(resources.getColor(R.color.breathe_text));
//
//            mTime = new Time();
        }
...
//
        ...
        public void onDraw(Canvas canvas, Rect bounds) {
            String text = mAmbient ? "" : "Tap to Resume Breathe";
...
//
        ...
        public void onApplyWindowInsets(WindowInsets insets) {
            ...
            float textSize = resources.getDimension(isRound
                    ? R.dimen.breathe_text_size_round : R.dimen.breathe_text_size);
